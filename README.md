...
| <a name="input_create_postgresql"></a> [create\_postgresql](#input\_create\_postgresql) | Whether to deploy a PostgreSQL instance via the chart's subchart | `bool` | `true` | no |
| <a name="input_helm_chart_version"></a> [helm\_chart\_version](#input\_helm\_chart\_version) | The chart version of keycloakx (codecentric) | `string` | `"2.4.4"` | no |
...
| <a name="input_postgresql_port"></a> [postgresql\_port](#input\_postgresql\_port) | Port for the external database | `number` | `5432` | no |
...
| <a name="input_replicas"></a> [replicas](#input\_replicas) | Number of Keycloak replicas | `number` | `1` | no |
